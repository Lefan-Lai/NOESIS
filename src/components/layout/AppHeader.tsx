...
export function AppHeader() {
  ...
  return (
    <header className="flex h-[52px] shrink-0 items-center gap-2 border-b border-line px-3 max-[900px]:px-2">
      <div className="flex shrink-0 items-center gap-2 max-[900px]:min-w-0">
        <h1 className="whitespace-nowrap text-xl font-bold tracking-normal text-ink">
          NOESIS
        </h1>
        <select
          value={currentProjectId}
          onChange={(event) => switchProject(event.target.value)}
          className="h-8 w-[230px] rounded-md border border-line bg-white px-2 text-xs font-semibold text-slate-700 shadow-sm max-[1280px]:w-[200px] max-[900px]:w-[145px]"
          title="Project"
          aria-label="Project"
        >
        ...
        <button
          ...
          className="grid h-8 w-8 place-items-center rounded-md border border-line bg-white text-slate-700 shadow-sm hover:bg-slate-50"
        ...
        <button
          ...
          className="grid h-8 w-8 place-items-center rounded-md border border-line bg-white text-slate-700 shadow-sm hover:bg-slate-50 max-[900px]:hidden"
      ...
      <div className="ml-auto flex items-center gap-1.5">
        <label className="flex h-8 w-[330px] items-center gap-2 rounded-md border border-line bg-white px-2.5 text-sm text-muted shadow-sm max-[1280px]:w-[300px] max-[900px]:hidden">
          <Search size={15} />
          <input
          ...
          />
          <kbd className="rounded border border-line bg-slate-50 px-1.5 py-0.5 text-[11px] font-semibold text-slate-500">
            ⌘K
          </kbd>
        </label>
        <button
          onClick={() => setActiveUtilityPanel("help")}
          className="grid h-8 w-8 place-items-center rounded-md text-slate-700 hover:bg-slate-100 max-[900px]:hidden"
          title="Help"
          aria-label="Help"
        >
          <CircleHelp size={18} />
        ...
        <button
          ...
          className="ml-1 flex h-8 items-center gap-1.5 whitespace-nowrap rounded-md bg-atlasBlue px-3 text-xs font-semibold text-white shadow-sm shadow-blue-200 max-[900px]:px-2"
        >
